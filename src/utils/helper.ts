...
// 专门微信代码高亮的解析器
const markdownParserWechat = new MarkdownIt({
  html: true,
  highlight: (str, lang) => {
...
export const parserMarkdownByWechat = (
  mdContent: string,
  imageHost: string
): string => {
  return markdownParserWechat

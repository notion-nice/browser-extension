...
>(({ className, children, portalProps, ...props }, ref) => (
  <DialogPortal {...portalProps}>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "nf-fixed nf-left-[50%] nf-top-[50%] nf-z-50 nf-grid nf-w-full nf-max-w-3xl nf-translate-x-[-50%] nf-translate-y-[-50%] nf-gap-4 nf-border nf-bg-background nf-p-6 nf-shadow-lg nf-duration-200 data-[state=open]:nf-animate-in data-[state=closed]:nf-animate-out data-[state=closed]:nf-fade-out-0 data-[state=open]:nf-fade-in-0 data-[state=closed]:nf-zoom-out-95 data-[state=open]:nf-zoom-in-95 data-[state=closed]:nf-slide-out-to-left-1/2 data-[state=closed]:nf-slide-out-to-top-[48%] data-[state=open]:nf-slide-in-from-left-1/2 data-[state=open]:nf-slide-in-from-top-[48%] sm:nf-rounded-lg",
        className
      )}
      {...props}>
      {children}

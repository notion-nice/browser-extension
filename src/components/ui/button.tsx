...
const buttonVariants = cva(
  "nf-inline-flex nf-items-center nf-justify-center nf-whitespace-nowrap nf-rounded-md nf-text-sm nf-font-medium nf-transition-colors focus-visible:nf-outline-none focus-visible:nf-ring-1 focus-visible:nf-ring-ring disabled:nf-pointer-events-none disabled:nf-opacity-50",
  {
    variants: {
      variant: {
        default:
